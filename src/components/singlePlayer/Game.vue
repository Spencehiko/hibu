...
const { startRound, endGame } = store;
const { teams, roundTeam, roundStarted, gameWinner } = storeToRefs(store);
</script>
...
<template>
    <div class="game">
        <div v-if="gameWinner !== -1">
            <h1>Oyun Bitti!</h1>
            <p>
                Kazanan takım: {{ teams[gameWinner].name }}!
            </p>
            <button type="button" @click="endGame" class="new-game-btn">Yeni Oyun</button>
            <div class="pyro">
                <div class="before"></div>
                <div class="after"></div>
            </div>
        </div> 
        <div v-else-if="!roundStarted">
...
.start-round-btn:hover, .new-game-btn:hover {
